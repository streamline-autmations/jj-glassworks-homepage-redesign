          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-[#4ea6dd] text-white border-2 border-transparent transition-colors hover:bg-white hover:text-[#4ea6dd] hover:border-[#4ea6dd]"
              >
